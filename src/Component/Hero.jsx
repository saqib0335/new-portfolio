...
import ali from '../assets/saqib.jpg';
  ...
  return (
    <section className='flex min-h-screen flex-col items-center justify-center gap-4 lg:gap-6' ref={heroRef}>
        <div className='mt-8 lg:mt-20'>
            ...
            <h2 className='hero-subheading bg-gradient-to-b from-pink-200 to-purple-300 bg-clip-text text-center 
        ...
        <a href='/saqib-ali01.pdf' target='_blank' rel='noopener noreferrer' download className='hero-btn mb-6 flex gap-1 rounded-full border 
