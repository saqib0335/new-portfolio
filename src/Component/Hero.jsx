  ...
  return (
    <section className='flex min-h-screen flex-col items-center justify-center gap-4 lg:gap-6' ref={heroRef}>
        <div className='mt-11 lg:mt-20'>
            ...
            <h2 className='hero-subheading bg-gradient-to-b from-pink-200 to-purple-300 bg-clip-text mt-5 text-center 
            text-2xl tracking-tighter'>
                {PROFILE.role}
            </h2>
        </div>
        <p className='hero-text max-w-3xl p-1 text-center text-xl tracking-tighter lg:text-2xl'>
            {PROFILE.subheading}
        </p>
